...
interface RetenoHostApi {
  fun initWith(accessKey: String, lifecycleTrackingOptions: NativeLifecycleTrackingOptions?, isPausedInAppMessages: Boolean, useCustomDeviceIdProvider: Boolean, isDebug: Boolean, deviceTokenHandlingMode: NativeDeviceTokenHandlingMode, defaultNotificationChannelConfig: NativeDefaultNotificationChannelConfig?)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val deviceTokenHandlingModeArg = args[5] as NativeDeviceTokenHandlingMode
            val defaultNotificationChannelConfigArg = args[6] as NativeDefaultNotificationChannelConfig?
            val wrapped: List<Any?> = try {
              api.initWith(accessKeyArg, lifecycleTrackingOptionsArg, isPausedInAppMessagesArg, useCustomDeviceIdProviderArg, isDebugArg, deviceTokenHandlingModeArg, defaultNotificationChannelConfigArg)
              listOf(null)
