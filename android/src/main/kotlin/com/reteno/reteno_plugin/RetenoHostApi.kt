...
data class NativeRecomFilter (
  ...
  companion object {
    @Suppress("UNCHECKED_CAST")
    fun fromList(list: List<Any?>): NativeRecomFilter {
      val name = list[0] as String
      val values = list[1] as List<String?>
...
data class NativeRecomEvent (
  ...
  companion object {
    @Suppress("UNCHECKED_CAST")
    fun fromList(list: List<Any?>): NativeRecomEvent {
      val eventType = NativeRecomEventType.ofRaw(list[0] as Int)!!
      val dateOccurred = list[1] as String
      val productId = list[2] as String
...
data class NativeRecomEvents (
  ...
  companion object {
    @Suppress("UNCHECKED_CAST")
    fun fromList(list: List<Any?>): NativeRecomEvents {
      val recomVariantId = list[0] as String
      val events = list[1] as List<NativeRecomEvent?>
