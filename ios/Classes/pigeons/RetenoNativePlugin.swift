...
enum NativeDeviceTokenHandlingMode: Int {
  case automatic = 0
  case manual = 1
}
...
struct NativeInAppCustomData: Hashable {
  var url: String? = nil
  var source: String
  var inAppId: String
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> NativeInAppCustomData? {
    let url: String? = nilOrValue(pigeonVar_list[0])
    let source = pigeonVar_list[1] as! String
    let inAppId = pigeonVar_list[2] as! String
  ...
  static func == (lhs: NativeInAppCustomData, rhs: NativeInAppCustomData) -> Bool {
...
/// Generated class from Pigeon that represents data sent in messages.
struct NativeDefaultNotificationChannelConfig: Hashable {
  var name: String? = nil
  var description: String? = nil
  var showBadge: Bool? = nil
  var lightsEnabled: Bool? = nil
  var vibrationEnabled: Bool? = nil


  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> NativeDefaultNotificationChannelConfig? {
    let name: String? = nilOrValue(pigeonVar_list[0])
    let description: String? = nilOrValue(pigeonVar_list[1])
    let showBadge: Bool? = nilOrValue(pigeonVar_list[2])
    let lightsEnabled: Bool? = nilOrValue(pigeonVar_list[3])
    let vibrationEnabled: Bool? = nilOrValue(pigeonVar_list[4])
  ...
  static func == (lhs: NativeDefaultNotificationChannelConfig, rhs: NativeDefaultNotificationChannelConfig) -> Bool {
    return deepEqualsRetenoNativePlugin(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashRetenoNativePlugin(value: toList(), hasher: &hasher)
  }
...
private class RetenoNativePluginPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 130:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return NativeDeviceTokenHandlingMode(rawValue: enumResultAsInt)
      }
      return nil
    case 131:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      ...
      return nil
    case 132:
      return NativeInAppCustomData.fromList(self.readValue() as! [Any?])
    case 133:
    ...
    case 141:
      return NativeDefaultNotificationChannelConfig.fromList(self.readValue() as! [Any?])
    case 142:
...
private class RetenoNativePluginPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? NativeInAppMessageStatus {
    ...
    } else if let value = value as? NativeDeviceTokenHandlingMode {
      super.writeByte(130)
      super.writeValue(value.rawValue)
    } else if let value = value as? NativeRecomEventType {
      super.writeByte(131)
      super.writeValue(value.rawValue)
    } else if let value = value as? NativeInAppCustomData {
      super.writeByte(132)
      ...
      super.writeByte(140)
      super.writeValue(value.toList())
    } else if let value = value as? NativeDefaultNotificationChannelConfig {
      super.writeByte(141)
      super.writeValue(value.toList())
...
protocol RetenoHostApi {
  func initWith(accessKey: String, lifecycleTrackingOptions: NativeLifecycleTrackingOptions?, isPausedInAppMessages: Bool, useCustomDeviceIdProvider: Bool, customDeviceIdValue: String?, isDebug: Bool, deviceTokenHandlingMode: NativeDeviceTokenHandlingMode, defaultNotificationChannelConfig: NativeDefaultNotificationChannelConfig?) throws
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: RetenoHostApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      initWithChannel.setMessageHandler { message, reply in
        ...
        let customDeviceIdValueArg: String? = nilOrValue(args[4])
        let isDebugArg = args[5] as! Bool
        let deviceTokenHandlingModeArg = args[6] as! NativeDeviceTokenHandlingMode
        let defaultNotificationChannelConfigArg: NativeDefaultNotificationChannelConfig? = nilOrValue(args[7])
        do {
          try api.initWith(accessKey: accessKeyArg, lifecycleTrackingOptions: lifecycleTrackingOptionsArg, isPausedInAppMessages: isPausedInAppMessagesArg, useCustomDeviceIdProvider: useCustomDeviceIdProviderArg, customDeviceIdValue: customDeviceIdValueArg, isDebug: isDebugArg, deviceTokenHandlingMode: deviceTokenHandlingModeArg, defaultNotificationChannelConfig: defaultNotificationChannelConfigArg)
    ...
    let requestPushPermissionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.reteno_plugin.RetenoHostApi.requestPushPermission\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      requestPushPermissionChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let provisionalArg = args[0] as! Bool
        api.requestPushPermission(provisional: provisionalArg) { result in
          switch result {
    ...
    let diagnoseChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.reteno_plugin.RetenoHostApi.diagnose\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      diagnoseChannel.setMessageHandler { _, reply in
        api.diagnose { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      diagnoseChannel.setMessageHandler(nil)
    }
...
protocol RetenoFlutterApiProtocol {
  ...
  func onNotificationDeleted(payload payloadArg: [String: Any?], completion: @escaping (Result<Void, PigeonError>) -> Void)
  func onCustomNotificationReceived(payload payloadArg: [String: Any?], completion: @escaping (Result<Void, PigeonError>) -> Void)
  func onInAppCustomDataReceived(payload payloadArg: NativeInAppCustomData, completion: @escaping (Result<Void, PigeonError>) -> Void)
...
class RetenoFlutterApi: RetenoFlutterApiProtocol {
  ...
  func onNotificationDeleted(payload payloadArg: [String: Any?], completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.reteno_plugin.RetenoFlutterApi.onNotificationDeleted\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([payloadArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
  ...
  func onCustomNotificationReceived(payload payloadArg: [String: Any?], completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.reteno_plugin.RetenoFlutterApi.onCustomNotificationReceived\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([payloadArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
  ...
  func onInAppCustomDataReceived(payload payloadArg: NativeInAppCustomData, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.reteno_plugin.RetenoFlutterApi.onInAppCustomDataReceived\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([payloadArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
