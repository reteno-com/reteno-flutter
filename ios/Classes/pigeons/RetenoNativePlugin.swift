...
protocol RetenoHostApi {
  func initWith(accessKey: String, lifecycleTrackingOptions: NativeLifecycleTrackingOptions?, isPausedInAppMessages: Bool, useCustomDeviceIdProvider: Bool, isDebug: Bool, deviceTokenHandlingMode: NativeDeviceTokenHandlingMode, defaultNotificationChannelConfig: NativeDefaultNotificationChannelConfig?) throws
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: RetenoHostApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      initWithChannel.setMessageHandler { message, reply in
        ...
        let deviceTokenHandlingModeArg = args[5] as! NativeDeviceTokenHandlingMode
        let defaultNotificationChannelConfigArg: NativeDefaultNotificationChannelConfig? = nilOrValue(args[6])
        do {
          try api.initWith(accessKey: accessKeyArg, lifecycleTrackingOptions: lifecycleTrackingOptionsArg, isPausedInAppMessages: isPausedInAppMessagesArg, useCustomDeviceIdProvider: useCustomDeviceIdProviderArg, isDebug: isDebugArg, deviceTokenHandlingMode: deviceTokenHandlingModeArg, defaultNotificationChannelConfig: defaultNotificationChannelConfigArg)
