...
class NativeDefaultNotificationChannelConfig {
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! NativeDefaultNotificationChannelConfig || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 130: 
        final int? value = readValue(buffer) as int?;
        return value == null ? null : NativeDeviceTokenHandlingMode.values[value];
      case 131: 
        final int? value = readValue(buffer) as int?;
      ...
      case 141: 
        return NativeDefaultNotificationChannelConfig.decode(readValue(buffer)!);
      case 142: 
...
class RetenoHostApi {
  ...
  Future<void> initWith({required String accessKey, NativeLifecycleTrackingOptions? lifecycleTrackingOptions, bool isPausedInAppMessages = false, bool useCustomDeviceIdProvider = false, bool isDebug = false, NativeDeviceTokenHandlingMode deviceTokenHandlingMode = NativeDeviceTokenHandlingMode.automatic, NativeDefaultNotificationChannelConfig? defaultNotificationChannelConfig, }) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[accessKey, lifecycleTrackingOptions, isPausedInAppMessages, useCustomDeviceIdProvider, isDebug, deviceTokenHandlingMode, defaultNotificationChannelConfig]);
  ...
  Future<bool> requestPushPermission({bool provisional = false}) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.reteno_plugin.RetenoHostApi.requestPushPermission$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[provisional]);
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
  ...
  Future<List<String>> diagnose() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.reteno_plugin.RetenoHostApi.diagnose$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<Map<String, Object>> getRecommendationsJson({required String recomVariantId, required List<String> productIds, String? categoryId, List<NativeRecomFilter>? filters, List<String>? fields, }) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.reteno_plugin.RetenoHostApi.getRecommendationsJson$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
abstract class RetenoFlutterApi {
  ...
  static void setUp(RetenoFlutterApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.reteno_plugin.RetenoFlutterApi.onNotificationDeleted$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
    ...
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.reteno_plugin.RetenoFlutterApi.onCustomNotificationReceived$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
    ...
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.reteno_plugin.RetenoFlutterApi.onInAppCustomDataReceived$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          final List<Object?> args = (message as List<Object?>?)!;
          final NativeInAppCustomData? arg_payload = (args[0] as NativeInAppCustomData?);
          assert(arg_payload != null,
